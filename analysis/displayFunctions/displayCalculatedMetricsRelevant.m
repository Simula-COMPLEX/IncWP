function displayCalculatedMetricsRelevant(vesselName, resultsPath)
    ...
    nameLatexMap = containers.Map( ...
        ...
        {'$\texttt{IncWP}$', ...
         ...
         '$\texttt{FullWP50}$', ...
         '$\texttt{FullWP100}$', ...
         '$\texttt{FullWP10}_{TimeCutoff}$', ...
         '$\texttt{FullWP50}_{TimeCutoff}$', ...
         '$\texttt{FullWP100}_{TimeCutoff}$', ...
         '$\texttt{RandomSearch}$', ...
         '$\texttt{IncWP}_{KP}$', ...
         '$\texttt{IncWP}_{Unst}$', ...
         '$\texttt{IncWP}_{Prox}$', ...
         '$\texttt{IncWP}_{Rnd}$', ...
         '$\texttt{IncWP}_{K2Means}$', ...
         '$\texttt{IncWP}_{K3Means}$', ...
         '$\texttt{IncWP}_{K5Means}$', ...
         '$\mathit{fit_{distWPs}}$', ...
         '$\mathit{fit_{unstable}}$'});
    nameMapPlot = containers.Map( ...
        ...
        {'\texttt{FullWP10}', ...
         '\texttt{FullWP50}', ...
         '\texttt{FullWP100}', ...
         '\texttt{FullWP10-TimeCutoff}', ...
         '\texttt{FullWP50-TimeCutoff}', ...
         '\texttt{FullWP100-TimeCutoff}', ...
         '\RandomSearch', ...
         '\KneeSel', ...
         '\IncWP_Unst', ...
         '\IncWP_Prox', ...
    ...
    orderOfPlots = ["FullWP10", "FullWP50", "FullWP100", "FullWP10_TimeCutoff", "FullWP50_TimeCutoff", "FullWP100_TimeCutoff", "RandomSearch", "IncWP_KP", "IncWP_Unst", "IncWP_Prox", "IncWP_Rnd", "IncWP_K2Means", "IncWP_K3Means", "IncWP_K5Means"];
    orderOfPlots = orderOfPlots(ismember(orderOfPlots,string(experimentInfoMap.keys())));
    keys = {'FullWP10', ...
         'FullWP50', ...
         'FullWP100', ...
         'FullWP10_TimeCutoff', ...
         ...
         'IncWP_K5Means'};
    values = { ...
        [0.00, 0.60, 0.00]; ... % FullWP10
        [0.00, 0.40, 0.00]; ... % FullWP50
        [0.00, 0.25, 0.00]; ... % FullWP100
        [0.30, 0.75, 0.30]; ... % FullWP10_TimeCutoff
        [0.30, 0.60, 0.30]; ... % FullWP50_TimeCutoff
        [0.30, 0.45, 0.30]; ... % FullWP100_TimeCutoff
        [0.49, 0.18, 0.56]; ... % RandomSearch
        [0.93, 0.79, 0.00]; ... % IncWP_KP
        [0.00, 0.00, 0.55]; ... % IncWP_Unst
        [0.30, 0.75, 0.93]; ... % IncWP_Prox
        [0.72, 0.50, 0.85]; ... % IncWP_Rnd
        [1.00, 0.40, 0.20]; ... % IncWP_K2Means
        [0.85, 0.00, 0.00]; ... % IncWP_K3Means
        [0.55, 0.00, 0.00]; ... % IncWP_K5Means
    };
    %names = {}
    ...
    for fullApproach = orderOfPlots(startsWith(orderOfPlots,"FullWP"))
        displayStatistcalTestsFull(baseResultsPath,metrics, experimentInfoMap,orderOfPlots, vesselName, nameMapPlot, fullApproach)
    end
...
% KEEP
function displayStatistcalTestsFull(baseResultsPath, metrics, experimentInfoMap, orderOfPlots, vesselName, nameMap, approachName)
    orderOfPlots(orderOfPlots == approachName) = [];
