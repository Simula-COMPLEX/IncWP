...
%wpt.pos.x = [0 -151.7816 -241.5418   77.6677  315.5238   75.2546  266.0590];
%wpt.pos.y = 1.0e+03*[0    0.2328    0.6569    1.0566    1.2441    1.8291    2.0558];
%wpt.pos.z = [0  129.4868   18.9776  108.1885  185.0487   11.7270   85.9726];
