classdef waypointsRemus100ProblemMinWptDistanceMaxPathDist < PROBLEM
    properties
        points
    ...
    methods
        ...
        function Population = Initialization(obj,N)
            ...
            % 
            % 
            % = calculateSegmentLengths(initialWaypointsMatrix, R_switch,path);
            ...
            obj.intialSegementDistance = calculateSegmentLengths(initialWaypointsMatrix, obj.R_switch,fullpath);
        ...
        function PopObj = CalObj(obj, PopDec)
            ...
            for individualIndex = 1:size(PopDec,1)
                ...
                % 
                %  PopObj(individualIndex,:) = [-totalDistanceBetweenWaypoints subPathLength]; % minimize distance, maximise other objective
                ...
                segmenetDistanceDiff = segementDistance - obj.intialSegementDistance;
                %dtwDistance = calculateDTWdistance(intialPath, path)
                ...
                performance  = [-distanceBetweenPoints*0.1 segmenetDistanceDiff*10 -size(missingWaypoints,1)*10000]
...
function validation = pointsToClose(ListOfpoints, minDistance)
 ...
 % function dtwDistance = calculateDTWdistance(intialPath, generatedPath)
